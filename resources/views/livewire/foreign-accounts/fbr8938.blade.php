   ...
   @if ($currentStep == 1)
        <div class="mt-4 info-group">
            <div class="info-group-one">
                <p>Who is required to file? <span><i class="fa fa-exclamation"></i></span></p>
            </div>

            <div class="info-group-two">
                <p>Which accounts should be reported? <span><i class="fa fa-exclamation"></i></span></p>
            </div>
        ...
        @if ($isRequiredToFileFBAR == 'yes')
            <div class="rental-property-info-wrapper mt-3">
                <div class="rental-multibusiness-toggler">
                    <div>
                        <select class="business-income-date-input" wire:model="noOfProperties">
                            @foreach ($fBarAccount as $fBarAccount)
                                <option value="{{$fBarAccount}}">Account {{$fBarAccount}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="multibusiness-toggler-right">
                        <button type="button" wire:click='addfBarAccount({{$i}})' class="btn btn-default"><i class="fas fa-plus button_font_small"></i> Add another account</button>
                    ...
                    <form wire:submit.prevent=''>
                        <div class="form-group">
                            ...
                            <div class="mt-3">
                                ...
                                <input type="text" class="form-control business-income-medium-input" id="addressOfBank">
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control business-income-date-input" id="postalCode">
                                </div>
                                <div class="col-md-3">
                                    <label for="country">Country</label>
                                    <input type="text" class="form-control business-income-date-input" id="country">
                                </div>
                            </div>
                ...
                <div class="account-information-area mt-5">
                    <h6 class="section-header">
                        account information
                    </h6>
                    ...
                    <div class="mt-3">
                        ...
                        <input type="text" wire:model="accountType" class="form-control business-income-semi-input" name="">
                    </div>
                    ...
                    <div class="check-group mt-4">
                        ...
                        <div>
                            <input class="form-check-input" type="checkbox" wire:model='wasClosedDuringTaxYear' value="closedInTaxYear" id="defaultCheck1">
                            <label class="form-check-label" for="defaultCheck1">
