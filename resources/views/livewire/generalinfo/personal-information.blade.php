                            ...
                            <div class="form-group">
                                <div class="form-group light-grey">
                                    ...
                                    @if (!empty($uploadedSSNCard))
                                        <div>
                                            <span><i class="fa fa-file text-primary" style="font-size: 30px; display:inline"></i><a href="{{ storage_path('app/'.$uploadedSSNCard) }}">{{$uploadedSSNCard }}</a></span>
                                        </div>
                                    @endif
                                    ...
                                    <div class="form-group">
                                        <div class="form-group light-grey">
                                            ...
                                            @if (!empty($uploadedPassport))
                                                <div>
                                                    <span><i class="fa fa-file text-primary" style="font-size: 30px; display:inline"></i><a href="{{ storage_path('app/'.$uploadedPassport) }}">{{$uploadedPassport }}</a></span>
                                                </div>
                                            @endif
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-check">
                                        ...
                                        <label  class="form-check-label" for="DriversLicense">Drivers license   <a href="#">{{ $UploadedDL }} </a>
                                        </label>
                                      </div>
                                      <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="BirthCertificate">
                                         Birth certificate <a href="#">{{ $UploadedBirthCert }} </a>
                                        </label>
                                      </div>
                                      ...
                                      <div class="form-check">
                                        ...
                                        Foreign ID  <a href="#">{{ $UploadedForeignId }} </a>
                                        </label>
                                      </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-group light-grey">
                                            ...
                                            @if (!empty($uploadedSpouseSSN))
                                                <div>
                                                    <span><i class="fa fa-file text-primary" style="font-size: 30px; display:inline"></i><a href="{{ storage_path('app/'.$uploadedSpouseSSN) }}">{{$uploadedSpouseSSN }}</a></span>
                                                </div>
                                            @endif
                                    ...
                                    <div class="form-group">
                                        <div class="form-group light-grey">
                                            ...
                                            @if (!empty($uploadedSpousePassport))
                                                <div>
                                                    <span><i class="fa fa-file text-primary" style="font-size: 30px; display:inline"></i><a href="{{ storage_path('app/'.$uploadedSpousePassport) }}">{{$uploadedSpousePassport }}</a></span>
                                                </div>
                                            @endif
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="spusedriverlicensefile">Drivers license   <a href="#">{{ $UploadedSpouseDL }} </a>
                                        </label>
                                      </div>
                                      <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="spusedbirthcertfile">
                                         Birth certificate <a href="#">{{ $UploadedSpouseBirthCert }} </a>
                                        </label>
                                      </div>
                                      ...
                                      <div class="form-check">
                                        ...
                                        Foreign ID <a href="#">{{ $UploadedSpouseForiegnId }} </a>
                                        </label>
                                      </div>
