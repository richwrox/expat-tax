                    ...
                    <div class="col-md-3 mt-4">
                        <div class="form-group light-grey">
                            ...
                            @foreach ($uploadedAmendedReturnFiles as $uploadedAmendedReturnFile)
                               <span><i class="fa fa-file text-primary" style="font-size: 30px; display:inline"></i><a href="{{ storage_path('app/'.$uploadedAmendedReturnFile) }}">{{$uploadedAmendedReturnFile }}</a></span>
                            @endforeach
                                ...
                                <div class="form-group light-grey">
                                    ...
                                    @for($i=0; $i < $NumberofFormsToUpload; $i++) <div class="form-group mt-3">
                                        <div class="file btn btn-secondary cs-file-upload">
                                            ...
                                            <input wire:model="SupportingDocument" type="file" name="file[]" />
                                        </div>
                                </div>
                                @endfor
                        ...
                        <div class="form-group">
                            <div class="form-group light-grey">
                                ...
                                <div class="form-group mt-3">
                                    @if (!empty($UploadedPreviousUSTax))
                                        <div>
                                            <span><i class="fa fa-file text-primary" style="font-size: 30px; display:inline"></i><a href="{{ storage_path('app/'.$UploadedPreviousUSTax) }}">{{$UploadedPreviousUSTax }}</a></span>
                                        </div>
                                    @endif

                                    <div class="file btn btn-secondary cs-file-upload">
                                        <i class="fa fa-upload mr-4"></i> Last Filed US TAX return.pdf
                                        <input wire:model="UploadPreviousUSTax" type="file" name="file" />
                                    </div>
                                </div>
