                                                       ...
                                                       @switch($currentView)
                                                         ...
                                                         @case('general-question')
                                                              ...
                                                              <div class="col-md-12 ml-5">
                                                                  <div class="form-group">
                                                                      <div class="form-group light-grey">
                                                                          ...
                                                                          <input wire:model="CorporateOrPartnerTax" type="radio" class="btn-check" id="btn-corp-p2" autocomplete="off" name="Year" value="no">
                                                                          <label class="btn btn-outline-secondary btn-site-primary mr-3" for="btn-corp-p2">No</label>
                                                           ...
                                                           <div class="form-group mt-4">
                                                                <div class="form-group light-grey">
                                                                  <div class="row">
                                                                    <label class="mb-2" for="">Please choose the type of return you wish to file</label><br/>
                                                                    <div class="col-md-6">
                                                            ...
                                                            <div class="form-group mt-4">
                                                                <div class="form-group light-grey">
                                                                    ...
                                                                    <input wire:model="AmendedReturns" type="radio" class="btn-check" id="btn-AmendedReturnsNo" autocomplete="off" name="AmendedReturns" value="no" onchange="">
                                                                    <label wire:click="$emit('ToggleAmendedReturns','no')" class="btn btn-outline-secondary btn-site-primary mr-3" for="btn-AmendedReturnsNo">No</label>
                                                      ...
                                                      <div class="mt-4 d-flex">
                                                            ...
                                                            <div class="form-group mt-4">
                                                                <div class="form-group light-grey">
                                                                    ...
                                                                    <input wire:model="ReturningClient" type="radio" class="btn-check" id="btn-check-2-returningclient" autocomplete="off" name="returningclient" value="no" onchange="">
                                                                    <label class="btn btn-outline-secondary btn-site-primary mr-3" for="btn-check-2-returningclient">No</label>
                                                            ...
                                                            <div class="form-group mt-4">
                                                                <div class="form-group light-grey">
                                                                    ...
                                                                    <input wire:model="FiledPreviousUSTax" type="radio" class="btn-check" id="btn-checkpreviousustaxno" autocomplete="off" name="filedustax" value="no" onchange="">
                                                                    <label class="btn btn-outline-secondary btn-site-primary mr-3" for="btn-checkpreviousustaxno">No</label>
                                                            ...
                                                            <div class="form-group mt-4">
                                                                <div class="form-group light-grey">
                                                                    ...
                                                                    <input wire:model="FiledExtention" type="radio" class="btn-check" id="btn-check-2-extension" autocomplete="off" name="filedextention" value="no" onchange="">
                                                                    <label class="btn btn-outline-secondary btn-site-primary mr-3" for="btn-check-2-extension">No</label>
                                                        ...
                                                        <div  class="row mt-5">
                                                          ...
                                                          <div class="comment-area">
                                                            ...
                                                            <div class="col-md-6 offset-md-6">
                                                                ...
                                                                <div class="mr-5">
                                                                    <button wire:click="submitSectionOne" class="btn btn-outline-secondary mr-3 btn-site-primary color-text-white my-5 mx-5 ml-5">
                                                                      ...
                                                                      <div class="mr-5 button_font_small">
                                                                        ...
                                                                        class="btn mr-3 btn-outline-secondary btn-site-primary color-text-white mb-5 mt-5 button_font_small"> Streamlined procedure <i class="fas fa-arrow-right button_font_small"></i>
                                                                        </button>
                                                                    </div>
                                                            ...
                                                            <div class="form-group col-md-6 light-grey">
                                                              <label class="mb-2" for="">Are you filing streamlined? 
                                                                ...
                                                                @error('StreamLinedFile') <span class="error text-danger">*</span> @enderror 
                                                                    ...
                                                                    <input wire:model="StreamLinedFile" type="radio" class="btn-check" id="btn-corp-pstreamline2"  name="streamline" value="no">
                                                            ...
                                                            <div class="col-md-10 offset-md-2">
                                                                <div class="row mr-auro">
                                                                    <div class="mr-5 button_font_small">
                                                                       ...
                                                                       <button wire:click="$emit('back', 4 )" class="btn btn-outline-secondary mr-3 btn-site-primary color-text-white my-5 mx-5 ml-5"><i class="fas fa-arrow-left button_font_small"></i>
                                                                          <span class="pl-1 button_font_small">Filing Questions</span>
                                                                      </button>

                                                                        <button wire:click="submitStreamline" type="button" class="btn btn-outline-secondary mr-3 btn-site-primary color-text-white mb-5 mt-5 button_font_small"> General Question <i class="fas fa-arrow-right button_font_small"></i>
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                             ...
                                             To increase ID safety the IRS sometimes issues IP Pins to individuals to be used on the tax return. Once a pin has been issued the tax return cannot be efiled without it.</span>
                                                              ...
                                                              <div class="form-group mt-4">
                                                                <div class="form-group light-grey">
                                                                    ...
                                                                    <input wire:model="LivingInUS" type="radio" class="btn-check" id="btn-check-2-outlined" name="LivingUS" value="no" onchange="">
                                                            ...
                                                            <div class="form-group mt-4">
                                                                <div class="form-group light-grey">
                                                                    ...
                                                                    <input wire:model="IPPIN" type="radio" class="btn-check" id="btn-IPPIN-2-outlined" autocomplete="off" name="IPPIN" value="no" onchange="">
                                                                    <label wire:click="$emit('SetPINStatus', 'no' )" class="btn btn-outline-secondary btn-site-primary mr-3" for="btn-IPPIN-2-outlined">No</label>
                                                    ...
                                                    <div class=" offset-md-4">
                                                        <div class="rows mr-auro">
                                                          ...
                                                          <div class="d-flex ">
                                                                ...
                                                                <div class="mr-5">
                                                                    <button wire:click="submitGeneralQuestion" class="btn btn-outline-secondary mr-3 btn-site-primary color-text-white my-5 mx-5 ml-5">
                                                                        <span class="pl-3 button_font_small"> Personal Infomation <i class="fas fa-arrow-right button_font_small"></i></span>
                                                                    </button>
                                                                </div>
