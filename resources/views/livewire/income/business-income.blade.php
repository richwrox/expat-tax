<div>
   ...
   {{-- this if statement changes the form to display based on the step --}}
    @if ($currentStep == 1)
                            ...
                            <div class="col-md-12 ml-5">
                                <div class="form-group">
                                        <div class="row mt-2">
                                            <div class="col-md-8">
                                                ...
                                                <input  wire:model="BusinessName.{{0}}" type="text" class="form-control" name="">
                                            </div>
                                ...
                                <div class="col-md-12 ml-5">
                                    <div class="form-group">
                                            <div class="row mt-2">
                                                <div class="col-md-8">
                                                    <input wire:model="BusinessName.{{$key+1}}" type="text" class="form-control" name="">
                                                </div>
                                                <div class="col-md-2" style="display: flex; align-items:flex-end">
                    ...
                    @if ($hasSelfEmployedor1099Nec == 'yes')
                            <div class="row mt-3">
                                ...
                                @if (!empty($UploadedfileForDocRevach))
                                    <div>
                                        <span><i class="fa fa-file text-primary" style="font-size: 30px; display:inline"></i><a href="{{ storage_path('app/'.$UploadedfileForDocRevach) }}">{{$UploadedfileForDocRevach }}</a></span>
                                    </div>
                                @endif
        ...
        <form wire:submit.prevent='submitCostOfGoodSold'>
            <div class="row mt-4">
            <div class="form-group">
