<div>
            ...
            <div class="form-group light-grey">
                <label class="mb-2" for="">Is this your first time filing an 1120S  corporate return with us?
                    @error('isFirstTimeFiling1120s')<span class="error">*</span> @enderror
                </label><br />
                <input type="radio" wire:model="isFirstTimeFiling1120s" class="btn-check form-check-input "
                    name="isFirstTimeFiling1120s" id="isFirstTimeFiling1120sYes" value='yes'>
                <label class="btn btn-outline-secondary mr-3 btn-site-primary"
                    for="isFirstTimeFiling1120sYes">Yes</label>

                <input wire:model="isFirstTimeFiling1120s" type="radio" class="btn-check form-check-input"
                    name="isFirstTimeFiling1120s" id="isFirstTimeFiling1120sNo" value='no'>
                <label class="btn btn-outline-secondary btn-site-primary" for="isFirstTimeFiling1120sNo">No</label>
            </div>

            @if ($isFirstTimeFiling1120s == 'yes')
                <div class="row mt-3">
                    <div class="col-md-8 ml-5">
                        <div class="form-group light-grey">
                            <label class="mb-2" for="">
                                Provide a copy of the last filed Form 1120S of the corporation if any
                            </label>
                            <div class="file btn btn-outline-success cs-file-upload">
                                    <i class="fa fa-upload mr-4"></i> Upload Forms
                                <input wire:model="fileFor1120s" type="file"  />
                            </div>
                            <div wire:loading wire:target="fileFor1120s">Uploading...</div>
                        </div>
                    </div>
                </div>
            @endif
